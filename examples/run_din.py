...
def get_xy_fd():
    #feature_column_dict = {"sparse": [SparseFeat('user', 3), SparseFeat(
    ...
    #x = [feature_dict[feat.name] for feat in feature_column_dict["sparse"]] + [feature_dict[feat.name]
    #                                                                        for feat in feature_column_dict["dense"]] + [

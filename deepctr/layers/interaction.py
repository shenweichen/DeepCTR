...
class AFMLayer(Layer):
    ...
    interactions without linear term and bias.
      ...
      Arguments
        ...
        - **dropout_rate** : float between 0 and 1. Fraction of the attention net output units to dropout.
    ...
    def __init__(self, attention_factor=4, l2_reg_w=0, seed=1024, **kwargs):
    ...
    def call(self, inputs,training=None, **kwargs):
        ...
        #attention_output = tf.keras.layers.Dropout(self.dropout_rate,seed=self.seed)(attention_output)#training
    ...
    def get_config(self, ):
        config = {'attention_factor': self.attention_factor,
                  'l2_reg_w': self.l2_reg_w, 'seed': self.seed}
